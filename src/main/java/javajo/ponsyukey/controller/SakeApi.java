...
public interface SakeApi {
     ...
     * POST /sake : 酒情報登録API
     *
     * @param UNKNOWN_BASE_TYPE 酒情報登録に必要な情報 (required)
    ...
    default ResponseEntity<Object> createSake(@ApiParam(value = "酒情報登録に必要な情報" ,required=true )  @Valid @RequestBody UNKNOWN_BASE_TYPE UNKNOWN_BASE_TYPE) {
